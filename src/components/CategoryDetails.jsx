...
const CategoryDetails = () => {
    ...
    return (
        <div className='mt-2 mb-5'>
            <div className='w-[90%]   mx-auto lg:w-[100%] lg:h-[70%] '>
                <div className='relative z-10'>
                    <img src={image} className='mx-auto  w-full' alt={title} />
                    <div className='absolute bottom-0 z-10 py-3 sm:py-6 left-0 right-0 bg-black opacity-50'>
                ...
                <p className='mt-5 text-xs sm:text-xl text-[#0B0B0BB2]'>{description}</p>
            </div>
        </div>
    )
}
